...
class YahooFantasyService:
    ...
    def fetch_league_config(self) -> Dict[str, Any]:
        ...
        return {
            "scoring_config": settings_data.get("stat_categories", {}),
    ...
    def fetch_all_waiver_wire_data(self) -> Dict[int, List[Dict[str, Any]]]:
        lg = self.get_league()
        end_week = lg.end_week()
        ...
        for week in range(1, end_week + 1):
            ...
            all_waiver_data[week] = self.fetch_waiver_wire_availability(week)
        return all_waiver_data